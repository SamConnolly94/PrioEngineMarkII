...
namespace PrioEngineII
{
	...
	public:
		...
		d3dDepthStencilViewHeap(ComPtr<DirectXDeviceType>& d3dDevice, EEngineTypes engineType)
		{
			mEngineType = engineType;
			CreateDepthStencilViewHeap(d3dDevice);
		}
	private:
		/// <summary>
	...
	private:
		...
		void CreateDepthStencilViewHeap(ComPtr<DirectXDeviceType>& d3dDevice)
		{
